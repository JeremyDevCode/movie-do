  ...
  return (
    <nav className={isScrolled ? 'bg-black fixed w-full text-white h-20 px-12 z-10' : 'bg-gradient-to-t from-transparent to-[#00000080] fixed w-full text-white h-20 px-12 z-10'}>
        ...
        <div className='flex items-center justify-between h-full'>
            ...
            <div className='flex items-center'>
                <div onClick={() => (pathname !== '/discover' ? router.push('/discover') : console.log('You can search now 😉'))}>
                <div className={`flex items-center  h-10 rounded-full transition ease-in ${pathname === '/discover' ? 'w-48 bg-neutral-800' : 'w-10'}`}>
